...
<?php
	...
	if(isset($_POST['submit']))
	{
		if(strcmp($_POST['pword1'],$_POST['pword2']) == 0)
		{
			...
			{
				$sqlNewUser = "INSERT INTO Users (User, Email) VALUES ('$uname', '$email')";
				$sqlNewPassword = "INSERT INTO Passwords (password, userID) VALUES ('$pword', '".$_SESSION['userid']."')";				
				$resultNewUser = mysql_query($sqlNewUser);
				$resultNewPassword = mysql_query($sqlNewPassword);
				...
				{
					if(mysql_affected_rows() == 1)	echo "Password added successfully";
					else							echo "Password not added";
				}
				else
					echo mysql_error();	
			}
